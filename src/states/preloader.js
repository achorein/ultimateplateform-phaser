class Preloader extends Phaser.State {
    ...
    preload() {
        ...
        this.game.add.sprite(this.game.centerX, this.game.centerY, 'phaser').anchor.set(0.5);

        //setup loading bar
        this.asset = this.add.sprite(this.game.centerX - 110, this.game.centerY + 150, 'preloader');
